<script lang='ts'>
    ...
    async function createCheckoutSession() {
        ...
        console.log(import.meta.env.VITE_STRIPE_PRODUCT_BUILDER_PROPOSAL_FEEDBACK);
        ...
        await fetch('/stripe/checkout-session', {
            ...
            body: JSON.stringify({ priceId: import.meta.env.VITE_STRIPE_PRODUCT_BUILDER_PROPOSAL_FEEDBACK })
        })
