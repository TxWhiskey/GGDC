...
const Root = (0, import_index_8e09b0bf.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_8e09b0bf.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_8e09b0bf.v)(components[0] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => `${components[2] ? `${(0, import_index_8e09b0bf.v)(components[1] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
      default: () => `${components[3] ? `${(0, import_index_8e09b0bf.v)(components[2] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {
        default: () => `${(0, import_index_8e09b0bf.v)(components[3] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_3 || {}), {}, {})}`
      })}` : `${(0, import_index_8e09b0bf.v)(components[2] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`}`
    })}` : `${(0, import_index_8e09b0bf.v)(components[1] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`
  })}` : `${(0, import_index_8e09b0bf.v)(components[0] || import_index_8e09b0bf.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
const handle = async ({ request, resolve: resolve2 }) => {
  ...
  await import_firebase_admin.default.auth().verifySessionCookie(sessionCookie, true).then((decodedClaims) => {
  ...
  return __spreadValues({}, response);
};
